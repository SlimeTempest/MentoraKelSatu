    ...
    <div class="space-y-6">
        ...
        <div class="rounded-lg bg-gradient-to-r from-blue-600 to-blue-700 p-6 text-white shadow-lg">
            ...
            <p class="mt-1 text-blue-100">
                You're logged in as <span
                    class="font-semibold capitalize bg-white/20 px-2 py-1 rounded-full">{{ auth()->user()->role }}</span>
            </p>
        </div>
        ...
        @if (auth()->user()->role === 'admin')
            ...
            <section class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    {{-- Total Revenue --}}
                    <div
                        class="group rounded-lg bg-gradient-to-br from-green-600/20 to-green-700/10 p-6 shadow-lg border border-green-500/30 transition-all duration-200 hover:border-green-500/50 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="rounded-lg bg-green-500/20 p-3 group-hover:scale-110 transition-transform duration-200">
                    ...
                    {{-- Total Users --}}
                    <div
                        class="group rounded-lg bg-gradient-to-br from-purple-600/20 to-purple-700/10 p-6 shadow-lg border border-purple-500/30 transition-all duration-200 hover:border-purple-500/50 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="rounded-lg bg-purple-500/20 p-3 group-hover:scale-110 transition-transform duration-200">
                    ...
                    {{-- Total Jobs --}}
                    <div
                        class="group rounded-lg bg-gradient-to-br from-blue-600/20 to-blue-700/10 p-6 shadow-lg border border-blue-500/30 transition-all duration-200 hover:border-blue-500/50 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="rounded-lg bg-blue-500/20 p-3 group-hover:scale-110 transition-transform duration-200">
                    ...
                    {{-- Completed Jobs --}}
                    <div
                        class="group rounded-lg bg-gradient-to-br from-emerald-600/20 to-emerald-700/10 p-6 shadow-lg border border-emerald-500/30 transition-all duration-200 hover:border-emerald-500/50 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-4">
                            <div
                                class="rounded-lg bg-emerald-500/20 p-3 group-hover:scale-110 transition-transform duration-200">
                    ...
                    <div class="flex items-center justify-between">
                        <h2 class="text-xl font-bold text-gray-100">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round" class="inline-block align-middle text-orange-400 mr-2">
                                <path
                    ...
                    <div class="grid gap-4 md:grid-cols-2">
                        @if (($stats['pending_topups'] ?? 0) > 0)
                            <a href="{{ route('admin.topups.index') }}"
                                class="group relative rounded-lg bg-gradient-to-br from-orange-600/20 to-orange-700/10 p-6 shadow-lg border-2 border-orange-500/50 transition-all duration-200 hover:border-orange-500 hover:shadow-xl hover:scale-[1.02]">
                                ...
                                <div class="flex items-center gap-4">
                                    <div
                                        class="rounded-lg bg-orange-500/20 p-4 group-hover:scale-110 transition-transform duration-200">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-400 mb-2">There are <span
                                                class="font-semibold text-orange-400">{{ $stats['pending_topups'] }}</span>
                                            topup requests waiting for approval</p>
                                        <span
                                            class="inline-flex items-center text-sm text-orange-400 font-medium group-hover:translate-x-1 transition-transform duration-200">
                                            Review now
                        ...
                        @if (($stats['pending_reports'] ?? 0) > 0)
                            <a href="{{ route('admin.reports.index') }}"
                                class="group relative rounded-lg bg-gradient-to-br from-red-600/20 to-red-700/10 p-6 shadow-lg border-2 border-red-500/50 transition-all duration-200 hover:border-red-500 hover:shadow-xl hover:scale-[1.02]">
                                <div class="absolute top-4 right-4">
                                    <span
                                ...
                                <div class="flex items-center gap-4">
                                    <div
                                        class="rounded-lg bg-red-500/20 p-4 group-hover:scale-110 transition-transform duration-200">
                                        <svg class="h-8 w-8 text-red-400" fill="none" stroke="currentColor"
                                            viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-gray-400 mb-2">There are <span
                                                class="font-semibold text-red-400">{{ $stats['pending_reports'] }}</span>
                                            reports waiting for review</p>
                                        <span
                                            class="inline-flex items-center text-sm text-red-400 font-medium group-hover:translate-x-1 transition-transform duration-200">
                                            Review now
                                            <svg class="ml-1 h-4 w-4" fill="none" stroke="currentColor"
                                                viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
            ...
            <section class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-3">
                    <div
                        class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 hover:border-blue-500 transition-all duration-200 hover:shadow-xl">
                    ...
                    <div
                        class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 hover:border-green-500 transition-all duration-200 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-3">
                    ...
                    <div
                        class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 hover:border-emerald-500 transition-all duration-200 hover:shadow-xl">
                        <div class="flex items-center justify-between mb-3">
            ...
            <section class="space-y-4">
                ...
                <div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <a href="{{ route('jobs.index') }}"
                        class="group rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 transition-all duration-200 hover:border-blue-500 hover:shadow-xl hover:scale-[1.02]">
                        <div class="flex flex-col items-center text-center">
                            <div
                                class="rounded-lg bg-blue-500/20 p-4 mb-4 group-hover:scale-110 transition-transform duration-200">
                    ...
                    <a href="{{ route('admin.topups.index') }}"
                        class="group rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 transition-all duration-200 hover:border-green-500 hover:shadow-xl hover:scale-[1.02]">
                        <div class="flex flex-col items-center text-center">
                            <div
                                class="rounded-lg bg-green-500/20 p-4 mb-4 group-hover:scale-110 transition-transform duration-200">
                    ...
                    <a href="{{ route('admin.reports.index') }}"
                        class="group rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 transition-all duration-200 hover:border-orange-500 hover:shadow-xl hover:scale-[1.02]">
                        <div class="flex flex-col items-center text-center">
                            <div
                                class="rounded-lg bg-orange-500/20 p-4 mb-4 group-hover:scale-110 transition-transform duration-200">
                                <svg class="h-8 w-8 text-orange-400" fill="none" stroke="currentColor"
                                    viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M9 17v-2m3 2v-4m3 4v-6m2 10H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z">
                    ...
                    <a href="{{ route('admin.users.index') }}"
                        class="group rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 transition-all duration-200 hover:border-purple-500 hover:shadow-xl hover:scale-[1.02]">
                        <div class="flex flex-col items-center text-center">
                            <div
                                class="rounded-lg bg-purple-500/20 p-4 mb-4 group-hover:scale-110 transition-transform duration-200">
        ...
        @else
                ...
                <div class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-2xl font-bold text-white">Rp
                                {{ number_format($stats['balance'] ?? 0, 0, ',', '.') }}</p>
                        </div>
                ...
                <div class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="mt-2 text-2xl font-bold text-white">Rp
                                {{ number_format($stats['total_earned'] ?? 0, 0, ',', '.') }}</p>
                        </div>
            ...
            <div class="grid gap-6 md:grid-cols-2">
                <a href="{{ route('jobs.index') }}"
                    class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 hover:border-blue-500 transition-colors">
                    <div class="flex items-center gap-4">
                        <div class="rounded-full bg-blue-500/20 p-3">
                            <svg class="h-6 w-6 text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a href="{{ route('topups.create') }}"
                    class="rounded-lg bg-gray-800 p-6 shadow-lg border border-gray-700 hover:border-green-500 transition-colors">
                    <div class="flex items-center gap-4">
                        <div class="rounded-full bg-green-500/20 p-3">
                            <svg class="h-6 w-6 text-green-400" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
